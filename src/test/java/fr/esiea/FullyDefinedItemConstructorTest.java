...
public class FullyDefinedItemConstructorTest {
    ...
    public FullyDefinedItemConstructorTest(Item item, String expectedName, int expectedSellIn, int expectedQuality, int expectedPrice, int expectedQuantity) {
        this.item = item;
