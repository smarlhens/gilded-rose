...
public class PartlyDefinedItemConstructorTest {
    ...
    public PartlyDefinedItemConstructorTest(Item item, String expectedName, int expectedSellIn, int expectedQuality) {
        this.item = item;
